...
{ value: 'Peon', label: 'Peon' },
    ...
    { value: 'ADVANCED PROGRAMMING FRAMEWORKS', label: 'ADVANCED PROGRAMMING FRAMEWORKS'}, { value: 'CSharp', label: 'CSharp'},
    { value: 'TypeScript', label: 'TypeScript' }, { value: 'SpringBoot', label: 'SpringBoot' }, { value: 'ExpressJS', label: 'ExpressJS' },
    { value: 'NextJS', label: 'NextJS'}, { value:'Django', label: 'Django' },{ value: 'Flask', label: 'Flask' },
    { value: 'CLOUD & INFRASTRUTURE', label: 'CLOUD & INFRASTRUTURE'}, { value: 'GoogleCloud', label: 'GoogleCloud'},
    { value: 'Terraform',label:'Terraform'},{value:'Ansible',label:'Ansible'},{value:'CloudFormation',label:'CloudFormation'},
    { value: 'MultiCloud', label: 'MultiCloud' }, { value: 'Serverless', label: 'Serverless' },
    { value: 'CloudSecurity', label: 'CloudSecurity' },  { value: 'LoadBalancing', label: 'LoadBalancing' },{ value: 'CI_CD', label: 'CI_CD' },
